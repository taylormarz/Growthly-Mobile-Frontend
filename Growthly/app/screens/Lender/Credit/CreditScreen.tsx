	...
	return (
		<View style={styles.screenContainer}>
			...
			<View style={styles.scoreContainer}>
				...
				<Text style={styles.scoreDescriptor}>
			...
			<View style={styles.breakdownContainer}>
				...
				<View style={styles.detailComponent}>
					<View style={styles.breakdownLabel}>
						<Text style={[styles.breakdownText, styles.breakdownText2]}>
							Credit Utilization
						</Text>
				...
				<View style={styles.detailComponent}>
					<View style={styles.breakdownLabel}>
						<Text style={[styles.breakdownText, styles.breakdownText3]}>
							Derogatory Marks
						</Text>
						<Text style={styles.breakdownLabelText}>Going Great</Text>
						<View style={styles.greenSquare} />
