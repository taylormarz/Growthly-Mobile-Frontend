  ...
  return (
    <View style={styles.navbar}>
      <TouchableOpacity
        ...
        onPress={() => router.push('/screens/Dashboard/DashboardScreen')}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconContainer}
        onPress={() => router.push('/screens/Loans/LoansScreen')}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconContainer}
        onPress={() => router.push('/screens/Matches/MatchesScreen')}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconContainer}
        onPress={() => router.push('/screens/Credit/CreditScreen')}
      >
        <Image
      ...
      <TouchableOpacity
        style={styles.iconContainer}
        onPress={() => router.push('/screens/Settings/main/SettingsScreen')}
      >
        <Image
